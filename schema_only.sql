...
SELECT pg_catalog.setval('public.dim_content_type_content_type_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.dim_platform_platform_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.dim_sentiment_sentiment_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.fact_sentiment_events_fact_id_seq', 6053, true);
...
SELECT pg_catalog.setval('public.global_keywords_global_keyword_id_seq', 107, true);
...
SELECT pg_catalog.setval('public.keyword_cache_cache_id_seq', 5, true);
...
SELECT pg_catalog.setval('public.ml_models_model_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.silver_errors_error_id_seq', 6, true);
...
SELECT pg_catalog.setval('public.silver_reddit_comments_silver_comment_id_seq', 5223, true);
...
SELECT pg_catalog.setval('public.silver_reddit_posts_silver_post_id_seq', 1128, true);
...
SELECT pg_catalog.setval('public.silver_twitter_tweets_silver_tweet_id_seq', 38, true);
...
SELECT pg_catalog.setval('public.user_sessions_session_id_seq', 32, true);
...
SELECT pg_catalog.setval('public.verification_tokens_token_id_seq', 16, true);
